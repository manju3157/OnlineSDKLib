...
class AuthenticationViewController: UIViewController, UITextFieldDelegate
{
    ...
    @IBAction func authenticate(_ sender: AnyObject)
    {
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv1.5", message: "Authentication Successful", preferredStyle: .alert)
        ...
        {
            let alertController = UIAlertController(title: "OPGSDKv1.5", message: "Authentication Failed", preferredStyle: .alert)
